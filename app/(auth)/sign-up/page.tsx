  ...
  return (
    <div className={'container'}>
      <div className={'flex justify-center items-center'}>
        <div className={'flex flex-col items-center justify-center gap-[20px] my-[100px]'}>
          ...
          <div className={'w-[440px]'}>
            <form className={'flex flex-col items-center justify-center gap-[1.5rem]'}>
              <Input type={'text'} placeholder={'email'} className={'rounded-[20px] px-[16px] bg-transparent border-2 border-[#feb2b2] text-[16px] !outline-none'} />
              <Input type={'text'} placeholder={'password'} className={'rounded-[20px] px-[16px] bg-transparent border-2 border-[#feb2b2] text-[16px] !outline-none'} />
