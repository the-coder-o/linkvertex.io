        ...
        <Animation delay={3}>
          <div className={'flex flex-col gap-5 mt-5'}>
            ...
            <div className={'flex flex-col gap-2'}>
              ...
              <p className={'text-white text-justify  max-sm:text-[15px] max-sm:leading-normal'}>
                In an ever-expanding digital universe, your online presence is a constellation of profiles, platforms, and portfolios. At Linkvertex.io, we provide the gravity that holds your digital cosmos together, creating a singular, powerful point of connection between you and your audience.
            ...
            <div className={'flex flex-col gap-2'}>
              ...
              <p className={'text-white text-justify  max-sm:text-[15px] max-sm:leading-normal'}>
                Our intuitive interface is designed for the digital novice and expert alike, ensuring you can manage your links with ease and efficiency. Security is not an afterthought; it's woven into the very fabric of our platform. We continuously evolve to implement robust security measures
                that protect your information and your peace of mind.
              </p>
            </div>
          </div>
        </Animation>
