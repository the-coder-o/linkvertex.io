    ...
    <>
      <main className={'container'}>
        <div className={'mt-[14.5rem] max-md:mt-[14rem] flex items-center flex-col justify-center gap-[3.5rem] max-md:gap-[2rem]'}>
          ...
          <Animation delay={1}>
            <p className={'w-[410px] font-[600] text-white leading-[1.5rem] text-center max-sm:w-[85%] ml-auto mr-auto'}>One link to rule them all. Easily place your links in a beautiful single page.</p>
          </Animation>
          <Animation delay={2}>
