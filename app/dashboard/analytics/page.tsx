  ...
  return (
    <div className={'container'}>
      <div className={'flex items-center justify-center flex-col mt-[250px] gap-[15px]'}>
        <motion.h1 initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.1 }} className={'text-white text-[55px] w-[500px] text-center font-bold leading-tight'}>
